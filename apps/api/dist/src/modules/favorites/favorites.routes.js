...
favoritesRouter.post('/', requireAuth, requireCsrf, validate(favoriteSchema), asyncHandler(async (req, res) => {
...
favoritesRouter.delete('/:archiveItemId', requireAuth, requireCsrf, validate(favoriteIdSchema), asyncHandler(async (req, res) => {
